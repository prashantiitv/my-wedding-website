$(document).ready(function () {
  ...
  var myCalendar = createCalendar({
    ...
    data: {
      ...
      // Event Description
      description:
        "We can't wait to see you on our big day. For any queries or issues, please contact Mr. Vinay Bharti at +91 8299364882.",
    },
  });
  ...
  $("#rsvp-form").on("submit", function (e) {
    ...
    if (
      ...
      $.post(
        "https://script.google.com/macros/s/AKfycbyf5soaAAQ1szVdGqAeOGBQWAECrahFksmKYG633xt11cscTqU/exec",
        data
      )
        .done(function (data) {
          console.log(data);
...
// Google map
// function initMap() {
//   var location = { lat: 26.791440191647155, lng: 83.36874412643859 };
...
//   var la_fiesta = { lat: 26.791454557346523, lng: 83.3687870413126 };
//   var map = new google.maps.Map(document.getElementById("map-canvas"), {
//     zoom: 15,
//     center: la_fiesta,
//     scrollwheel: false,
