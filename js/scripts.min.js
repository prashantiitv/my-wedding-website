...
$(document).ready(function () {
  ...
  for (var n = 0; n < e.length; n++) {
    var o =
      ...
      '&amp;via=prashant&amp;hashtags=prashantandrani&amp;count=horizontal"style="width:105px; height:21px;"></iframe><iframe src="//www.facebook.com/plugins/like.php?href=' +
      encodeURIComponent(window.location) +
  ...
  var r = createCalendar({
    ...
    data: {
      ...
      address: "Prince Lawn, Gorakhpur, Uttar Pradesh 273004, India",
      description:
